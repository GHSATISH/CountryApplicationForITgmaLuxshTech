...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.inMemoryAuthentication().withUser("samar@gmail.com").password("samar@123").roles("ADMIN");
		auth.inMemoryAuthentication().withUser("chandan@gmail.com").password("chandan@123").roles("USER");
